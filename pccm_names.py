...
def name_clinical(module_name):
    if module_name == "clinical_exam_initial":
        ...
        col_list = ['Location_Mammography', 'First_Mammography', 'LatestDate_Mammography', 'Number_Mammography',
                    ...
                    'Asso_features_Architectural_distortion_Mammography', 'Asso_features_Calcifications_Mammography',
                    'Lesion_Depth_Mammography', 'Lesion_LateralLocation_Mammography',
                    'Lesion_QuadrantLocation_Mammography', 'Lesion_DistancefromNipple_Mammography',
                    'Lesion_DistanceFromPectMaj_Mammography', 'Category_BI_RADS_Mammography',
