...
tables = ["Patient_Information_History", 'Radiology', "Follow_up_Data", "HormoneTherapy_Survival", "Radiotherapy",
...
tables = ["Patient_Information_History", 'Radiology', "HormoneTherapy_Survival", "Radiotherapy",
         "General_Medical_History", "Family_Cancer_History", 'Previous_Cancer_History', 'Nutritional_Supplements',
         'Physical_Activity', 'Breast_Feeding', 'NACT_Tox_table','NACT_Drug_Table', 'Neo_Adjuvant_Therapy',
          'Adjuvant_ChemoTherapy', 'Chemo_Tox_table', 'Chemo_Drug_Table']
...
conn_all = sqlite3.connect(path_all)
cursor_all = conn_all.cursor()
table = ["Patient_Information_History", 'Radiology', "Follow_up_Data", "HormoneTherapy_Survival", "Radiotherapy",
         "General_Medical_History", "Family_Cancer_History", 'Previous_Cancer_History', 'Nutritional_Supplements',
         'Physical_Activity', 'Breast_Feeding', 'NACT_Tox_table','NACT_Drug_Table', 'Neo_Adjuvant_Therapy',
          'Adjuvant_ChemoTherapy', 'Chemo_Tox_table', 'Chemo_Drug_Table']
for index in table:
