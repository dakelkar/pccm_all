...
def name_clinical(module_name):
    if module_name == 'clinical_exam_initial':
        col_list = ['consent_status', 'consent_form_status', 'provisional_diagnosis_clinical_examination_ce',
                    ...
                    'leftarm_upperlimbvolume_cc_ce', 'leftarm_elbowdistance_cm_ce', 'follow_up_advised_ce', 'update_by',
                    'last_update']
...
def names_radio(module_name):
    if module_name == 'mammography':
        col_list = ['mammography', 'mammography_date', 'mammography_place', 'mammography_indication',
        ...
        col_list = ['sonomammography_status', 'sonomammo_date', 'sonomammo_breast', 'sonomammo_mass', 'sonomammo_mass_number',
        ...
        col_list = ['mri_status', 'date_mri', 'accession_number_mri', 'mri_breast', 'fibroglandular_tissue_mri',
...
def names_nact(module_name):
    if module_name == 'nact_tox_table':
        ...
        col_list = ['file_number', 'drugs_administered', 'number_cycle', 'cycle_frequency_per_week', 'drug_dose', 'dose_unit']
...
def db_tables():
    tables = ['patient_information_history', 'block_list', 'biopsy_path_report_data', 'clinical_exam', 'radiology',
              'neo_adjuvant_therapy', 'surgery_report', 'surgery_path_report_data','adjuvant_chemotherapy',
              'radiotherapy', 'hormonetherapy_survival', 'follow_up_data']
    return tables
