def nact_regime(conn, file_number):
    ...
    from sql.add_update_sql import review_input as review_input
    ...
    while not check:
        ...
        if nact:
            ...
            week_end, cycle_index, week_index,  = (0,)*4
            drug_cycle = True
            while drug_cycle:
                check_cycle = False
                while not check_cycle:
                    ...
                    while week_add:
                        ...
                        while not check_drug_tox:
                            ...
                            check_drug_tox = review(tox_response_all.loc[week_index])
                    ...
                    data_cycle_all = [file_number, cyc_name, weeks, patient_wt, drug_week, tox_week, tox_grade_week,
                    ...
                    check_cycle = review(data_per_cycle.loc[cycle_index])
            ...
            #drug_per_week.to_sql(table, conn, index = False, if_exists="append")
            #data_per_cycle.to_sql(table, conn, index = False, if_exists="append")
        ...
        data_list = [file_number, nact, date_nact, plan_nact, drug_admin,str(number_weeks), str(number_cycles), response_check, response_nact,
                     response_size, date, ovary_status, reason_incomplete, date_complete, trast_nact, trast_regime,
                     trast_courses, hormone_therapy, therapy_type, therapy_duration, therapy_side]
        col_list = names("NACT_Regime")
