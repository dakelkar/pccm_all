    ...
    while not check:
        ...
        if mri_breast:
            ...
            if mass_mri:
                ...
                mri_mass_number, mass_location, mass_quad, mass_shape, mass_margin, mass_internal = radio_tables.multiple_mass(
                    table, conn, cursor, file_number)
            else:
            ...
            asso_feat_1, asso_feat_2, asso_feat_3, asso_feat_4, asso_feat_5, asso_feat_6, asso_feat_7, asso_feat_8 = asso_feat_data
