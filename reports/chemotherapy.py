...
def chemotherapy(file_number, user_name):
    ...
    while not check:
        ...
        if chemo == 'Yes':
            place_chemo = ask_y_n_statement.ask_y_n_na("Has Adjuvant Chemotherapy been done at PCCM?", "At PCCM",
                                                       "Outside", "Not Certain, requires follow-up")
            details_chemo = ask_y_n_statement.ask_y_n("Are Adjuvant Chemotherapy details available?",
