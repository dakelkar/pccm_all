    ...
    while not check:
        ...
        if chemo == 'Yes':
            ...
            if details_chemo == "Follow-up required":
                ...
                therapy_type, therapy_duration, therapy_side, ovary_status, patient_wt = (details_chemo,)*27
            elif details_chemo == "Details Available":
                plan_chemo = input("What is the plan of Adjuvant Chemotherapy (for eg., 4 cycles AC + 12 cycles Paclitaxel):")
                date_start_chemo = input("Date of starting Adjuvant Chemotherapy: ")
                ...
                data_drug = ['Number_cycle','Drug', 'Drug_dose', 'Dose_unit']
                data_drug_list = []
                for index in data_drug:
                    data_drug = "; ".join(list(drug_table.loc[:,index]))
                    data_drug_list.append(data_drug)
                cyc_number, drug_cyc, drug_doses, drug_units = data_drug_list
                ...
                date_complete = input("Date of completion of Adjuvant Chemotherapy")
            ...
            place_chemo, plan_chemo, date_start_chemo, cyc_number, drug_cyc, drug_doses, drug_units, tox_type, tox_grade, \
            ...
            therapy_side, date_complete, reason_incomplete, details_chemo, patient_wt = (chemo,)*29
